...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 7415460964109183982),
      name: 'NoteModel',
      lastPropertyId: const IdUid(4, 4482141774573099403),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 7659070993416714955),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 2878175768892626111),
            name: 'title',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 4018553341967438502),
            name: 'comment',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(4, 4482141774573099403),
            name: 'date',
            type: 10,
            flags: 0)
      ],
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(1, 7415460964109183982),
